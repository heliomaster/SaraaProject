...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.dateTimeEdit_1.setDateTime(QtCore.QDateTime(QtCore.QDate(1999, 12, 31), QtCore.QTime(17, 0, 0)))
        ...
        self.total_le = QtWidgets.QLineEdit(self.layoutWidget)
        self.total_le.setObjectName("total_le")
        self.horizontalLayout.addWidget(self.total_le)
        ...
        self.dateEdit.setTime(QtCore.QTime(23, 59, 0))
        self.dateEdit.setObjectName("dateEdit")
        self.dateEdit_2 = QtWidgets.QDateEdit(self.splitter_2)
        self.dateEdit_2.setTime(QtCore.QTime(23, 59, 0))
